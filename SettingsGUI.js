...
function initializeAllSettings() {
    ...
    //RDailyVoids
    document.getElementById('RdMaxPraidZone').parentNode.insertAdjacentHTML('afterend', '<br>');
    ...
    //RPortal Line
    document.getElementById('RdRunNewVoidsUntilNew').parentNode.insertAdjacentHTML('afterend', '<br>');
