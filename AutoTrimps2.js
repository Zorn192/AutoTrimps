...
function mainLoop() {
	...
	if (getPageSetting('Rmanageequality') == true && game.global.fighting) Rmanageequality();
        ...
        //RRaiding
        if ((getPageSetting('RPraidHarder') == true && getPageSetting('RPraidingzone').length > 0 && game.global.challengeActive != "Daily") || (getPageSetting('RdPraidingzone').length > 0 && getPageSetting('RdMaxPraidZone').length > 0  && game.global.challengeActive == "Daily")) RPraidHarder();
        else {
