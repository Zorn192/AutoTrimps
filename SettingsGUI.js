...
function initializeAllSettings() {
    ...
    createSetting('dPraidingcell', 'Daily P Raiding Cell', 'What Cell to start P Raiding at. Recommend below your BW Raiding cell if used together. -1 to Raid at any cell. ', 'value', -1, null, 'Daily');
    ...
    createSetting('Praidingcell', 'P Raiding Cell', 'What Cell to start P Raiding at. Recommend below your BW Raiding cell if used together. -1 to Raid at any cell. ', 'value', -1, null, 'Raiding');
    ...
    //Heirloom Line
    document.getElementById('slot6nu').parentNode.insertAdjacentHTML('afterend', '<br>');
